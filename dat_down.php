...
var_dump($_SESSION);
if(@$_SESSION['dat_step'] == 'downloaded')
{
...
$_GET['GO'] = 'GO';
$_REQUEST['GO'] = 'GO';
$_REQUEST['links'] = $_SESSION['dat_links'];

$_POST['links'] = $_SESSION['dat_links'];
$_REQUEST['proxy'] = '';
$_REQUEST['proxyuser'] = '';
$_REQUEST['proxypass'] = '';
$_REQUEST['premium_user'] = '';
$_REQUEST['premium_pass'] = '';
$_REQUEST['cookie'] = '';
$_REQUEST['cleanname'] = 'on';
$_REQUEST['yt_fmt'] = 'highest';
$_REQUEST['server_dodelay'] = 'on';
$_REQUEST['serversidedelay'] = '';

require(TEMPLATE_DIR . '/header1.php');
?>
<br />
<center>
<?php
...
<?php
		...
		$start_link = 'dat_index.php?audl=doum';
...
<br />
<iframe width="100%" height="100" frameBorder="0" src="" name="idownload"><?php echo lang(30); ?></iframe>
<br />
<script>startauto();</script>
</center>
<?php
